...
type TransformItem = (item: Record<string, unknown>, client: HuduClient) => Record<string, unknown>
...
export function formatResult(result: unknown, client: HuduClient, opts: FormatOpts = {}): unknown {
